...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg border-2 border-black bg-gradient-to-r from-orange-400 to-orange-500 px-1 pb-1 transition-all ease-in-out hover:bg-gradient-to-b hover:from-orange-400 hover:to-orange-500 dark:border-orange-600 dark:from-orange-500 dark:to-orange-500`,
        className,
      )}
    >
      {children}
