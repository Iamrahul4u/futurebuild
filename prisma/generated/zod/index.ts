...
export const UserScalarFieldEnumSchema = z.enum(['id','username','firstName','secondName','email','hashedPassword','createdAt','updatedAt','role','about','locationId','profileCompleted','onboardingCompleted','roleSet','credits']);
